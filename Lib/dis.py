...
class Instruction(_Instruction):
    ...
    def _disassemble_fields(self, lineno_width=3, mark_as_current=False, offset_width=4, show_oparg=True):
    ...
    def _disassemble(self, lineno_width=3, mark_as_current=False, offset_width=4):
        return ' '.join(self._disassemble_fields(lineno_width=lineno_width, mark_as_current=mark_as_current,
                                                  offset_width=offset_width)).rstrip()
